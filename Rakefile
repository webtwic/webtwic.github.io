...
HTML::Proofer.new("./_site", {:href_ignore=> ['http://localhost:8000','http://github.com/webtwic'], :typhoeus => { :followlocation => true, :ssl_verifypeer => false, :headers => { 'User-Agent' => 'html-proofer' } }}).run

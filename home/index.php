...
* All HTML codes written by whizkydee(Olaolu Olawuyi)
   ...
   <div class="main_wrap" id="home-posts">
      ...
      <div class="first-col recent-posts left">
         ...
         <article class="article radius shadow-alt">
            ...
            <p class="article-date">March 18, 2015</p>
            ...
            <div class="article-social">
               ...
               <a target="_blank" href="https://www.facebook.com/sharer.php"><span class="webtwicons facebook-icon"></span></a>
               <a target="_blank" href="https://www.twitter.com/webtwic"><span class="webtwicons twitter-icon"></span></a>
               <a target="_blank" href="https://www.plus.google.com/webtwic"><span class="webtwicons google-plus-icon"></span></a>
               <a target="_blank" href=""><span class="webtwicons tumblr-icon"></span></a>
         ...
         <article class="article radius shadow-alt">
            ...
            <div class="article-excerpt">
               <p>
                  Choosing the right text editor has been a major challenge to most developers. As a developer, getting the right text editor to meet your needs really matters As a result of this, there are way lot of text editors available.
               </p>
            </div>
         ...
         <article class="article radius shadow-alt">
            ...
            <div class="article-excerpt">
               <p>
                  ...
                  you'll have to link the external fontawesome css file to your code.
               </p>
            </div>
         ...
         <article class="article radius shadow-alt">
            ...
            <div class="article-excerpt">
               <p>
                  ...
                  awesome cars like Ferrari, Bugatti, Lamborghini and other fancy cars.
               </p>
            </div>
         ...
         <article class="article radius shadow-alt">
            ...
            <div class="article-excerpt">
               <p>
                  Don't quit firefox because of the slowness as a result of your activities. There are diiferent methods you can use to speed up firefox but i'll be teaching you how to use firefox's page, i'll lead you.
               </p>
            </div>
      ...
      <div class="third-col right">
         ...
         <div class="trends-wrap radius shadow sidebar">
            ...
            <div class="category-title second-category-title"><p>Trending</p></div>
            <div class="category">

               <div class="category-posts"> <a href="apple-windows-7">Apple Stops Supporting Windows 7 in Boot Camp on New MacBook Pro, MacBook Air Models</a> </div>
               <div class="category-posts"> <a href="amazon-app">Amazon Is Reportedly Working on a 'Prime for Apps' Service</a> </div>
               <div class="category-posts"> <a href="amazon-app">Design Shots is a Minimalist Dribbble Client for iPhone </a> </div>
               <div class="category-posts"> <a href="google-docs">Google Docs Lets Admins Distribute Add-ons for Full Teams</a> </div>
               <div class="category-posts"> <a href="apple-cameras">Apple Invites Cameras Into Its Secret Apple Watch Fitness Lab</a> </div>
               <div class="category-posts"> <a href="amazon-app">Amazon Is Reportedly Working on a 'Prime for Apps' Service</a> </div>
         ...
         <div class="search-wrap radius shadow sidebar">
            ...
            <form method="GET">
               <input class="sidebar-input" type="search" name="s" placeholder="Search. e.g coding, html...">
               <input class="btn sidebar-button" type="submit" value>
